...
contacts = {
    'Taskify development team':{
        ...
        chats:[['Hezekiah Ivandi', 'Good morning!'],['You', 'Morning!']]
    },
    'Vie Huang':{
        name: 'Vie Huang',
        group: false,
    ...
    'Hezekiah Ivandi':{
        ...
        status: 'online',
        chats:[['Hezekiah Ivandi', "What's up!"], ['You', 'Good, how about you?']]
    ...
    'Marchella Angelina':{
        ...
        lastChat: "Hi",
        status: 'online',
        chats:[['Marchella Angelina', 'Hello!'], ['You', 'Hi']]
