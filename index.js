...
app.get("/chat", (req, res) => {
  ...
  const contacts = [
    { id: 1, isSelected: true, imageUrl: "assets/Pfp.png", name: "Taskify development team", latestChat: "Morning!" },
    { id: 2, isSelected: false, imageUrl: "assets/Pfp.png", name: "Vie Huang", latestChat: "Hello there!" },
    { id: 3, isSelected: false, imageUrl: "assets/Pfp.png", name: "Hezekiah Ivandi", latestChat: "How are you?" },
    { id: 4, isSelected: false, imageUrl: "assets/Pfp.png", name: "Marchella Angelina", latestChat: "I'm doing well, thank you!" },
  ];
  ...
  const chats = [
    ...
    { sender: { imageUrl: "assets/Pfp.png" }, message: "I'm doing well, thank you!" },
  ];
